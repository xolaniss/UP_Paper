...
## Macroprudential regulation and lending

\blandscape

```{r}
#| label: tbl-macropru_draft
#| tbl-cap: "Macroprudential Draft Regulation Results"
#| cache: FALSE
#| include: TRUE
#| ft.arraystretch: 0.5
...
```{r}
#| label: tbl-macropru_implementation
#| tbl-cap: "Macroprudential Regulation Implementation Results"
#| cache: FALSE
#| include: TRUE
...
modelsummary_word(
    macropru_results$implementation_models
  ) %>% 
    width(j = 1, width = 1.5)
