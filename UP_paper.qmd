...
#| tbl-cap: "Financial regulation and inclusion results"
#| cache: FALSE
#| include: TRUE
#| ft.arraystretch: 1
...
other_rows_tbl <- 
  tibble(
    "term" = "Financial regulations model (3-month lending)",
    `(1)` = " ",
    `(2)` = " ",
    `(3)` = " ",
    `(4)` = " ",
...
modelsummary_word(
  ...
  add_body_row(values =
                 c("Financial inclusion model (3-month lending)"),
               colwidths = 7) %>%
  add_header_row(
    values = c("Total"),
    colwidths = 7
  ...
  align(align = "center", part = "header", i = 1) %>%
  merge_at(i = 4, j = 1:7) %>%
  align(align = "center", part = "body", i = c(1, 4)) %>%
...
macropru_narratives_one_month_gg <- narratives$macropru$one_month_test_gg
...
macropru_narratives_one_month_gg <- narratives$macropru$three_month_test_gg
macropru_narratives_one_month_gg
...
#| tbl-cap: "Financial regulation and inclusion with controls results"
#| cache: FALSE
#| include: TRUE
#| ft.arraystretch: 0.8
...
other_rows_tbl <- 
  tibble(
    "term" = "Financial regulation model (3-month lending)",
    `(1)` = " ",
    `(2)` = " ",
    `(3)` = " ",
    `(4)` = " ",
...
modelsummary_word(
  ...
  merge_at(i = 8, j = 1:7) %>%
  align(align = "center", part = "body", i = c(1, 8)) %>%
  hline(i = 14, j = 1:7, part = "body") %>%
  mk_par(
    i = 2,
    part = "header",
    value = as_paragraph(dependant_other),
